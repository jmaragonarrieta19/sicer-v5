...
# ==========================================
st.set_page_config(page_title="SICER IA v5.2", layout="wide", initial_sidebar_state="collapsed")
...
# Carga de variables con manejo seguro de tipos (Para evitar AttributeError en listas)
for key in ["usuarios", "empresas", "propiedades_dinamicas", "lista_carac", "mensaje_intro", "fuente_intro", "tamano_intro", "align_intro", "linea_intro", "caracteristicas_18", "mensaje_final", "fuente_final", "tamano_final", "align_final", "linea_final", "solicitudes", "api_key", "model_name", "titulo_adicional", "texto_adicional", "firmas_config"]:
    if key not in st.session_state: 
        ...
        if key == "solicitudes" and not isinstance(val, list):
            val = []
            
        st.session_state[key] = val

if not isinstance(st.session_state.solicitudes, list):
...
if not st.session_state.logueado:
    st.markdown("""
        ...
        <div class="navbar-logo">SICER <span>IA v5.2</span></div>
    """, unsafe_allow_html=True)
            ...
            st.markdown("""
                <div style='text-align: center; margin-bottom: 30px;'>
                    <h1 style='color: #1E293B; font-weight: 900; font-style: italic; font-size: 3.5rem; letter-spacing: -1.5px; margin:0;'>
                        SICER <span style='background: linear-gradient(135deg, #4E008E 0%, #6A0DAD 100%); color: white; padding: 4px 15px; border-radius: 99px; font-size: 1.4rem; font-style: normal; vertical-align: middle; margin-left:10px;'>IA v5.2</span>
                    </h1>
